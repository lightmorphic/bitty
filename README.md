...
Creating that isolated network + firewall setup needs root. There's no way to do a real kill
...
which has no route to your LAN or any host-local address regardless — so there's nowhere for a
